  ...
  <SectionWrapper id="education">
    ...
    <div className="relative max-w-2xl mx-auto">
      ...
      <motion.div
        ...
        className="absolute left-4 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-primary/60 via-primary/20 to-transparent origin-top"
      />
      ...
      {education.map((e, i) => (
        ...
        >
          {/* Pulsing dot */}
          <div
            className="absolute left-2.5 md:left-auto top-1.5 w-3 h-3 rounded-full bg-primary animate-dot-pulse md:right-auto"
