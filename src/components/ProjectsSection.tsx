...
const ProjectCard = ({ p, i, onOpen }: { p: typeof projects[0]; i: number; onOpen: () => void }) => (
  <motion.div
  ...
  >
    ...
    <p className="text-muted-foreground text-sm leading-relaxed mb-5 flex-1 line-clamp-2">{p.desc}</p>
